  ...
  <div class="collapse navbar-collapse justify-content-end" id="navbarSupportedContent">
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item">
        ...
        <a class="nav-link  active-button" href="<?php echo site_url('/week'); ?>">TYDZIEŃ REPORTERÓW</a>
      </li>
      <li class="nav-item">
...
<div class="container">
  <div class="row">
	...
	<div class="col-md-12">
<h1><?php the_title(); ?></h1>
<img class="img-fluid w-100" src="<?php echo get_the_post_thumbnail_url(get_the_ID()); ?>">
