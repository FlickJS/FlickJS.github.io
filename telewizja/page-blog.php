                            ...
                            <div class="carousel-item active">
                                <div class="card border-0 rounded-0 text-light overflow zoom">
                                    <div class="position-relative">
                                        <div class="ratio_left-cover-1 image-wrapper">
                                            <a href="<?php echo the_permalink(); ?>">
                                                <img class="img-fluid img-custom" src="<?php echo get_the_post_thumbnail_url(get_the_ID()); ?>">
                                            </a>
                                        </div>
                                    ...
                                    <a class="p-1 badge badge-primary rounded-0" href="<?php echo the_permalink(); ?>">Najnowszy Wpis</a>
                                            ...
                                            <div class="news-meta">
                                                <span class="news-author">Napisany przez <a class="text-white font-weight-bold" >Admin</a></span>
