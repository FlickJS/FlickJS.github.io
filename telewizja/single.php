...
while (have_posts()) {
    ...
    <div class="col-md-12">
      <br>
   <h1><?php the_title(); ?></h1> <p1>Opublikowano: <?php echo get_the_date( 'd-m-Y' ); ?>, <?php the_time( 'H:i:s' ); ?> przez <?php echo get_the_author_meta('display_name', $author_id); ?></p1>
   
   <img src="<?php echo get_the_post_thumbnail_url(get_the_ID()); ?>" class="single-img" />
   <br><br>
   <?php the_content();
